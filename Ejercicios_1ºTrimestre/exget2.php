...
<script>
	...
	edd = ed.value;
	if(edd < 18{alert("Eres menor de edad");
	document.getelementById('oo').stylevisibility = "hidden";
	}else{
	    document.getElementById('oo').stylevisibility = "visible";
    ...
    ?>
        ...
        <script>
            function validarEdad() {
                var edadInput = document.querySelector('input[name="edat"]');
        ...
        <form action="exget2.php" method="get">
            ...
            Edat*: <input onfocusout='edat()' type='number' id='edat' name="edat" required value="<?php echo $edat; ?>"><br>
		...
		<option hidden= ""> </option>
            ...
            <input type="checkbox" id="vehicle1" name="vehicle1" checked="Bici">
